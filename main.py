...
icon = pygame.image.load('images/witch1.png')
pygame.display.set_icon (icon)

# Background
background = pygame.image.load("images/moonlight.png")
...
# Spikes
spike=pygame.image.load("images/spikes.png")

# Sound/music
#mixer.music.load('')
#mixer.music.play(-1) # this will play the music on loop
jumping_sound = mixer.Sound("sounds/jump.wav")
jumping_sound.set_volume(0.2)# volume b/w 0-1

landing_sound1 = mixer.Sound("sounds/landing1.wav")
landing_sound2 = mixer.Sound("sounds/landing2.wav")
inAir = True

fall_sound1 = mixer.Sound("sounds/fall1.wav")
fall_sound2 = mixer.Sound("sounds/fall2.wav")

enemyDead_sound = mixer.Sound("sounds/punch.wav")
enemyDead_sound.set_volume(0.2)

# Player
playerImg = pygame.image.load('images/wizard1.png')
playerX = 0
playerY = 0
playerX_change = 0
playerY_change = 0
...
#enemy
enemyImg = pygame.image.load('images/goblin.png')
enemyX = 450
enemyY = 185
enemyX_change = 2
enemyY_change = 0
...
# health
health1 = pygame.image.load("images/diamond.png")
health2 = pygame.image.load("images/diamond.png")
health3 = pygame.image.load("images/diamond.png")
health_1X = 0
health_1Y = 0
health_2X = 20
health_2Y = 0
